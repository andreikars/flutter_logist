                    ...
                    items: [
                      ...
                      ...widget.declarations
                          ...
                          .map((decl) => DropdownMenuItem<int?>(
                                value: decl.id,
                                child: Text(
                                  'Декларация #${decl.declarationNumber}',
                                  style: const TextStyle(color: Colors.white),
                                ),
                              )),
                    ],
                    ...
                    children: [
                      ...
                      Expanded(
                        child: DropdownButtonFormField<String>(
                          ...
                          items: const [
                            DropdownMenuItem(value: 'BYN', child: Text('BYN', style: TextStyle(color: Colors.white))),
                            ...
                            DropdownMenuItem(value: 'RUB', child: Text('RUB', style: TextStyle(color: Colors.white))),
                          ],
                          onChanged: (value) {
                            setState(() {
                              _currency = value!;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: _getStatusBgColor(widget.payment!.status),
                              borderRadius: BorderRadius.circular(4),
                              border: Border.all(color: _getStatusColor(widget.payment!.status).withOpacity(0.3)),
                            ),
                            child: Text(

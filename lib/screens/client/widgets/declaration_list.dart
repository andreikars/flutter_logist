...
class DeclarationList extends StatelessWidget {
  ...
  Color _getStatusColor(String status) {
    switch (status.toUpperCase()) {
      ...
      case 'UNDER_REVIEW':
        return const Color(0xFF0d6efd); // Синий
      default:
  ...
  Color _getStatusBgColor(String status) {
    switch (status.toUpperCase()) {
      ...
      case 'UNDER_REVIEW':
        return const Color(0xFFcfe2ff); // Светло-синий
      default:
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: _getStatusBgColor(declaration.status),
                      borderRadius: BorderRadius.circular(6),
                      border: Border.all(color: _getStatusColor(declaration.status).withOpacity(0.3)),
                    ),
                    child: Text(
                      declaration.status,
                      style: TextStyle(
                  ...
                  Text(
                    '${declaration.productValue.toStringAsFixed(2)}',
                    style: TextStyle(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (declaration.netWeight != null)
                      _buildDetailRow('Вес', '${declaration.netWeight!.toString()} кг'),
